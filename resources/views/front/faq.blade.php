...
また、一度退会されますと同メールアドレスでの登録はできませんのでご了承下さい。'
						...
						'question' => [
							[
								...
								'ans' => '資金調達者とは、CROFUNでクラウドファンディングを行う人のことをいいます。商品提供者とは、ポイントで選べるカタログギフトに商品を提供してくれる人のことをいいます。資金提供者とは、そのクラウドファンディングに共感し、資金を提供して支援をする人のことをいいます。'
							],[
								'ques' => 'リターンとはなんですか？',
								...
								'ques' => 'CROFUNカタログとは？',
								'ans' => 'CROFUNでは、独自の商品カタログをご用意しております。プロジェクトにご支援いただくと、設定されているCROFUNポイントを取得することができます。このポイントを使ってCROFUNカタログに記載されている商品と交換することが可能です。<br>
