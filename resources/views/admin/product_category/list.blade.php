		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<a href="{{route('admin-product-category-add')}}" class="btn btn-success btn-sm pull-right">Add New</a>
				</div>
				<div class="card-body">
...
$(function() {
    var dataTable = $('#data-table').DataTable({
        ...
        //bSort: false,
        order: [ [4, 'desc'] ],
        ajax: "{!! route('admin-product-category-list-data') !!}",
        columns: [
            { data: 'name', name: 'name' },
            { data: 'subcategory_count', name: 'subcategory_count', bSearchable:false, bSortable:false},
