												...
												<div class="col-md-12 col-12 p-0 m-0 horizontal ">
													<div class="row inner_inner ml-md-3">
														<div class="col-md-6">
															<div class="row">
																<div class="col-md-12 project-item">
																	<img src="{{Request::root()}}/uploads/projects/{{$p->project->featured_image}}" alt="" class="img-fluid" width="300px" height="300px">
														...
														<div class="col-md-6 p-0">
															<div class="row ">
																<div class="col-md-8">
																	<h6 class="" style="font-size:14px; color:#bfc5cc;"> <span style="color:#bfc5cc;"> 	<i class="fa fa-tag"></i> <a href="/?c={{ $p->project->category->id }} ">{{$p->project->category->name}}</a>
																</div>
																<div class="col-md-4">
																	<a href="{{route('user-favourite-remove-project', ['id' => $p->project->id])}}" class="pull-right" style="font-size:14px;"><span style="color:#ed49b6;"> <i class="fa fa-heart"></i> </span>お気に入り削除</a>
																</div>
															</div>
															<div class="row mt-1">
															<a class="col-md-9" href="{{route('front-project-details', ['id' => $p->project->id])}}">
															...
															<div class="row mt-2">
																...
																<p class="text-center pt-1"><span class="pt-2 text-center" style="font-size:11px;">応援者</span>
																	<br>	<span class="p-0 m-0 text-center" style="font-size:21px;">{{ $p->project->investment->where('status', true)->count() }}人</span></p>
																</div>
																...
																<div class="col-md-6  p-md-0 ml-md-2">
																	<div style="font-size:15px;" class="">起案者：{{$p->project->user->first_name}} {{$p->project->user->last_name}}</div>
																	{{-- <div class=" div-radius1 m-0 p-0" style="height:40px"> --}}
																		<a href="{{route('front-project-details', ['id' => $p->project->id])}}" class=" bg-primary p-2 text-white btn btn-md btn-block font-weight-bold" style="padding:12px !important; margin-top: 5px;">プロジェクトを支援する</a>
																	{{-- </div> --}}
																</div>
															</div>
														</div>
