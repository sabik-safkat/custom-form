													...
													<div class="row inner_inner ml-md-3">
														<div class="col-md-6">
															<div class="row">
																<div class="col-md-12 project-item">
																	<img src="{{$p->product->image ?  asset('uploads/products/'.$p->product->image) : asset('uploads/projects/1615154785167836.jpeg')}}" alt="" class="img-fluid" width="300px" height="300px">
														...
														<div class="col-md-6 p-md-0">
															<div class="row ">
																...
																<div class="col-md-4">
																	<a href="{{route('user-favourite-remove-product', ['id' => $p->product->id])}}" class="pull-right" style="font-size:14px;"><span style="color:#ed49b6;"> <i class="fa fa-heart"></i> </span>お気に入り削除</a>
																</div>
															</div>
															<div class="row mt-1">
